...
# B. Held-plan persistence: make rename crash-durable on POSIX.
replace_once(
...
regression = r'''"""Regression coverage for PR #235 independent-review round two."""
...
if __name__ == "__main__":
    unittest.main()
'''
Path("tests/test_pr235_final_review_round2.py").write_text(textwrap.dedent(regression), encoding="utf-8")

for helper in (
    ".github/scripts/pr235_round2_patch.py",
    ".github/scripts/pr235_round2_patch_v2.py",
    ".github/workflows/pr235-round2-apply.yml",
):
