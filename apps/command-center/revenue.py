...
def revenue_state() -> dict[str, Any]:
    ...
    if not connected:
        return {
            ...
            "metrics": {"visitors": None, "clicks": None, "purchases": None, "revenue_cents": None, "revenue_usd": None},
            "closed_loop": ["qualified_traffic", "experiment_router", "offer", "click", "checkout", "paid_order", "attribution", "winner_gate", "reversible_promotion", "repeat"],
