...
def runtime_state() -> dict[str, Any]:
    """Read the host-generated canonical runtime snapshot.

    The web Command Center never invents production state. If the host bridge is
    unavailable or malformed, this function returns an explicit disconnected
    state rather than placeholder counters.
    """
